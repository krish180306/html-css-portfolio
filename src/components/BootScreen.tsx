  ...
  if (systemState === 'booting') {
    return (
      <div className="fixed inset-0 bg-black z-[9999] flex flex-col items-center justify-between select-none text-white overflow-hidden font-sans">
        ...
        <div className="flex flex-col items-center mt-12 relative w-full max-w-[600px]">
          <div className="relative flex justify-center mb-10 w-full ml-12">
            <img src={xpLogo} alt="Windows Logo" className="w-[200px] object-contain" />
          </div>
          <div className="relative flex flex-col items-center">
            <div className="absolute -top-7 left-1 text-[22px] tracking-wide text-white">
              Microsoft<sup className="text-[10px] ml-[1px]">®</sup>
            </div>
            <div className="flex items-end">
              <span className="text-[75px] font-bold tracking-[-2px] leading-none text-white">Windows</span>
              <span className="text-[48px] text-[#ff6600] font-bold italic ml-2 mb-4 tracking-tighter">xp</span>
            </div>
          </div>
          <div className="mt-28 w-[160px] h-[16px] border-[2px] border-gray-500 rounded-[5px] p-[1px] relative overflow-hidden bg-black">
  ...
  if (systemState === 'shutting_down') {
    return (
      <div className="fixed inset-0 bg-[#4a7cd0] z-[9999] flex flex-col justify-between select-none overflow-hidden font-sans">
        <div style={{ height: '72px', background: 'linear-gradient(180deg,#1a3c8e,#183688)', flexShrink: 0 }} />
        <div className="flex-1 flex flex-col items-center justify-center relative">
          ...
          <div className="flex items-center gap-8">
            <div className="w-[68px] h-[68px] bg-red-600 rounded-[4px] flex items-center justify-center text-4xl shadow-lg">📴</div>
            <div className="flex flex-col">
              <span className="text-white text-[28px] leading-tight font-semibold drop-shadow">Saving your settings...</span>
              <span className="text-blue-900 text-[15px] font-bold mt-1">Windows is shutting down...</span>
            </div>
          </div>
        </div>
        <div style={{ height: '72px', background: 'linear-gradient(180deg,#1a3c8e,#112888)', flexShrink: 0, position: 'relative' }}>
    ...
    >
      ...
      <div style={{ flex: 1, display: 'flex', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', paddingBottom: '40px' }}>
          ...
          {/* Logo block */}
          <div style={{ position: 'relative', paddingRight: '70px', paddingTop: '18px', marginBottom: '16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-end', lineHeight: 1 }}>
              ...
              <span style={{
                fontSize: '27px', fontWeight: '700', fontStyle: 'italic',
                color: '#ff6600',
          ...
          <p style={{
            ...
            fontWeight: '400', alignSelf: 'flex-start', marginLeft: 'calc(50% - 120px)',
          }}>
